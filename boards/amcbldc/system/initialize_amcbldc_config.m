...
AmcbldcInitConf(1).motor.externals.hall_sensors_swapBC = false;
...
AmcbldcInitConf(1).motor.externals.hall_sensors_offset = single(30);
...
AmcbldcInitConf(1).motor.externals.Kbemf = 0.0;
AmcbldcInitConf(1).motor.externals.Vmax = 24;
